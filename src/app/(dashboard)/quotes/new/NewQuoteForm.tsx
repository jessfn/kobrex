...
import { createQuoteAction, type ActionResult } from "@/lib/actions/quotes";
...
export function NewQuoteForm({
  ...
  const [state, formAction, pending] = useActionState<ActionResult, FormData>(createQuoteAction, {});
  ...
  if (clients.length === 0) {
    return (
      <Card className="text-center text-[var(--color-text-muted)]">
        Necesitas al menos un cliente antes de crear una cotización.{" "}
